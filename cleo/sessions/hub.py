...
def merge_session_rows(
    ...
    *,
    ...
    参数:
        managed: SessionStore.list_sessions() 返回的索引行。
        native: native harness 侧发现的会话, 来自
            productivity catalog loader 返回的
    ...
    返回:
        ...
        "cleo"/"cleo+native", 纯 native 行标记为 "native"。结果由
        productivity TUI 渲染,也被 tests/sessions/test_hub.py 验证。
    """
    linked = {
