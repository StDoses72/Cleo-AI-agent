...
export class DesktopUpdater {
  ...
  /** Purpose: Track installation through either the managed callback or legacy installer.
   * Input: Optional callback accepting the verified version and confirming the switch.
   * Output: Success flag; preparation failures remain visible until a fresh check/download.
   */
