...
/** Purpose: Unpack verified releases, including paths beyond Windows MAX_PATH.
 * Input: archive, destination and optional log callback. Output: extracted tree or an extraction error.
 */
export async function extract(archive, destination, { log = () => {} } = {}) {
