...
import { checkReleasePermission, releaseSource, tagCommit, findRelease, releaseTagPattern } from "./github-releases.mjs";
...
async function checkedRunResult(manager, tools, params, run) {
