...
from config.settings import ProductivitySettings, load_settings
from core.integrations.agent_adapter.acp import AcpProvider
...
from core.integrations.agent_adapter.factory import build_agent_adapter, create_provider
...
def test_separate_harnesses_config_loads_into_runtime_settings() -> None:
    settings = load_settings(
        PROJECT_ROOT / "config" / "cleo.example.json",
        PROJECT_ROOT / "config" / "harnesses.example.json",
    )
